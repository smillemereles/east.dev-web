...
const translations: Record<Locale, Record<string, any>> = {
  ...
  en: {
    ...
    seoClients: {
      section: "SEO",
      title: "How do they get so many clients?",
      description: "Most growing agencies combine several channels. SEO is one of the most powerful: they write useful content that answers what their ideal clients search for on Google, so they get found every day without paying for ads.",
      statLabel: "Clients via SEO",
      statDescription: "A web studio's new clients often come directly from organic Google searches.",
      internationalTitle: "International reach without borders",
      internationalDescription: "A well-ranked article can bring inquiries from the United States, Europe, or any country where you speak the same language as your client. We work in Spanish and English to expand that reach.",
      articlesTitle: "Example articles that attract clients",
      articles: [
        "Best Shopify Developers",
        "How Much Does a Website Cost?",
        "Custom Web Development in Utah",
      ...
      articlesNote: "When someone searches these terms, the studio that shows up first gets the inquiry. That's the power of SEO.",
      cta: "I want east.dev to help with SEO",
    },
    smartOrder: {
      section: "Smart Order",

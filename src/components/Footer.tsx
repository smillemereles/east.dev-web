      ...
      <div className="container-custom relative py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <motion.div variants={itemVariants}>
            <h4 className="font-display font-semibold mb-6 text-sm uppercase tracking-wider">
              {t("footer.navigation")}
            </h4>
        ...
        {/* Bottom */}
        <motion.div
          className="border-t border-border/30 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4"
